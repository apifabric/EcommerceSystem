...
resourcename="ecommercesystem"  # lower case, only
resourcegroup="ecommercesystem_rg"
...
# git clone https://github.com/apilogicserver/ecommercesystem.git
# cd ecommercesystem
...
az group create --name ecommercesystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group ecommercesystem_rg --sku S1 --is-linux
az container create --resource-group ecommercesystem_rg --name ecommercesystem --image apilogicserver/ecommercesystem:latest --dns-name-label ecommercesystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//ecommercesystem.westus.azurecontainer.io:5656'
